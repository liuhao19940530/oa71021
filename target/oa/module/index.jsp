...
<center>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1">
		      ...
		      <td width="18%" height="37" align="center"><b>访问地址</b></td>
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	          ...
	          <td align="center" vAlign="center">
	            <a href="module/findAll.action?pid=${module.id}">${module.name }</a>
	          ...
	          <c:if test="${my:getPermission(loginUser.id,'module',3)}"> 
	             <span style="cursor:hand;color:#0000ff;"
	                   onmouseover="this.style.color='#ff0000'"
	                   onmouseout="this.style.color='$0000ff'"
	                   onclick="del('${pageContext.request.contextPath}/module/delete.action?id=${module.id}');">
                                            删除	             
	             </span>
	          </c:if>   
	          </td>
